...
RESPONSE_MAP = {
    ("ちょまさ","運だけ"): [
        ...
        "トガの変身って顔だけなんかな\n体も変わるならデクに変身してちんちんシコシコしてたのかな",
        "酸のPH調整してもらって程よく痺れるくらいにして貰いたい","お茶子にきんたまの中身だけ無重力にしてもらったらイって無いのに精液出続けるのかな\nお茶子の手ってイボなのついてるんだっけ手コキめちゃくちゃ気持ち良さそう",
        "ヤオモモとセックスしたらマンコとか身体からからローションとか媚薬創りながらセックスできるのかな\nガチエロくね",
        "射精しました\nなんかすげえやる気無い感じだったけどそれも逆に興奮した","わざとじゃないんだけどイクって言ってからすぐ出しちゃって最初めっちゃ飛んだw\nその後手で抑えてたんだけど隙間から溢れてた笑笑\n昨日シコって無かったからめっちゃ濃いの出て手にめっちゃついててやばかったwwww",
        "べっとり付いてた","イクって言わずに出したら上手いこと顔にぶっかけられないかな別にイクって予告しなくていいしな","めっちゃパンツ見えるような座り方しててあれわざとだったんかな\nめちゃくちゃ凝視したかったけどチラチラ見る感じになっちゃって逆にキモかったかもしれん笑笑",
        "Aコースの乳首責めでイカせてもらった\nけどなんがもう触ってもらうだけじゃ満足しないかも\n隣にいるのに触れないのかーってなってちょっと萎え気味になっちゃうな",
        "ツクヨデブいくせに回避タンクとかいう試行回数無限のしょうもない対抗戦で強いくらいの性能なせいでカニの泡耐えないのゴミだわ\nなお対抗戦でツクヨは使われてない模様",
    ],
    "ゆずみつ": [
    ...
    "クローバー": [
        ...
        "学校でも端っこなのにネットでも端っこなのはあまりにも可哀想",
        "訂正、恐怖も感じる",
        "君の方が綺麗だよ","俺(品性抜き)を1つ\n店内で食います","口内炎痛すぎるんだが何故出来た？\nゴムしてるのに",
        "可愛いキャラが出たら無意識におっぱい見ちゃうんですよね、仕方ないよね三大欲求には抗えないんだから",
        "エリカさん実装おめでとうございます\n次は俺だ",
    ],
}
